...
//            , MemoryPolicy.NO_CACHE
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = Utility.INSTANCE.showProgress(ProfileActivity.this);
...
//        tvDeleteAccount.setTypeface(Utility.INSTANCE.getFontRegular());
 //       tvDeleteAccount.setVisibility(View.GONE);
        ...
        tvNotification.setOnClickListener(v -> startActivity(new Intent(ProfileActivity.this, NotificationActivity.class)));
        tvFamily.setOnClickListener(v -> startActivity(new Intent(ProfileActivity.this, FamilyMemberActivity.class)));
//        tvSetting.setOnClickListener(v -> startActivity(new Intent(ProfileActivity.this, SettingsActivity.class)));
        tvAbout.setOnClickListener(v -> startActivity(new Intent(ProfileActivity.this, AboutActivity.class)));
 //       tvFeedback.setOnClickListener(v -> startActivity(new Intent(ProfileActivity.this, FeedbackActivity.class)));
        tvLogout.setOnClickListener(v -> {
            dialogClose = Utility.INSTANCE.showAlert(ProfileActivity.this, R.string.dd_logout_msg, true, View.VISIBLE, R.string.dd_yes, v1 -> {
